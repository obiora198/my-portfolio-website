    ...
    <>
      ...
      >
        <div className="relative">
          ...
          <div className="hidden sm:block absolute top-0 bottom-0 w-full hover:bg-[rgba(0,0,0,0.5)] grid place-items-center text-4xl text-amber-100 text-center duration-1000 px-8">
            <span
              className={`${
          ...
          <div className='sm:hidden px-8 relative -top-16 text-center'>
            <div className='bg-gray-800 opacity-80 text-amber-200 text-3xl px-8 py-4 rounded-lg'>
            {title}
            </div>
          </div>
