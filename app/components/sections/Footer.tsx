...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-gradient-to-br from-indigo-700 via-purple-700 to-pink-600/90 dark:from-gray-900  dark:to-indigo-900 text-white relative overflow-hidden">
      {/* Enhanced background effects */}
      <div className="absolute inset-0 bg-gradient-to-t from-indigo-500/10 via-purple-500/10 to-pink-500/10 dark:from-gray-800/10 dark:via-purple-800/10 dark:to-indigo-800/10 backdrop-blur-lg"></div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-10 p-8 sm:p-16">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-8">
          ...
          <button
            onClick={toggleTheme}
            className="group relative p-5 rounded-2xl bg-white/15 backdrop-blur-xl border border-white/30 hover:border-white/50 transition-all duration-500 hover:scale-110 hover:bg-white/20 hover:shadow-2xl hover:shadow-yellow-500/30"
