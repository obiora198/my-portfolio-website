...
export default function Hero() {
  return (
    <>
      <div
        id="hero-section"
        className="h-screen md:min-h-screen text-amber-100 grid md:grid-cols-2 p-4 sm:px-16 md:px-32 lg:px-64 relative"
      >
        <div className="w-full h-full flex flex-col items-center justify-center gap-4">
          ...
          <p className="text-center text-3xl">
            ...
            and
            <span className="text-amber-200 text-4xl"> functional</span>{' '}
            fullstack web apps , feel free to look around and see some of my
            work.
          </p>
        </div>
