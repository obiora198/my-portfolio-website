    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          <Link
            href="/vtu"
            className={`inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r ${currentTheme.buttonGradient} text-white rounded-xl font-semibold hover:${currentTheme.buttonHover} transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105`}
          >
